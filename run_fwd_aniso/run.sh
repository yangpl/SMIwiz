...
makevel nz=151 nx=461 v000=0.1 > fepsil
makevel nz=151 nx=461 v000=-0.05 > fdelta
makevel nz=151 nx=461 v000=0 > fazimul
makevel nz=151 nx=461 v000=0 > fdip
...
aniso=1//0=isotropic, 1=VTI, 2=TTI
epsilfile=fepsil
deltafile=fdelta
azimulfile=fazimul
dipfile=fdip
